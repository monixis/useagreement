...
class usragr extends CI_Controller {
	public function index() {
		...
		$this -> load -> view('usragr_view', $data);
	}
/*	public function admin() {
	...
	public function updateResearcher($researcherId){
        ...
        $data = array(
				...
				'zipCode'=> $zip,
				'instAffilliation' => $institute,
				'date' => $date);
				 $result = $this->usragr_model->update_researcher($researcherId,$data);
				 echo $result;
			}
...
/*	public function reservationDetails(){
	...
	public function researchRequestForm(){
		date_default_timezone_set('US/Eastern');	
		$date = new DateTime();
		$this -> load -> model('rsrq_model');
		$data['title'] = "";
		...
		{
			$this->load->view('researchReqest_view', $data);
		}
		else
		{
			$reserverData = array(
