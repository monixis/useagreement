...
class usragr_model extends CI_Model
{
    ...
    */
    ...
    {
        $sql = "UPDATE researcher SET userName='$userName', country= '$country', state= '$state', city= '$city', address = '$address',emailId ='$emailId',phoneNumber='$phoneNumber', zipCode='$zipCode', date ='$date' , status= '$status' , userInitials = '$userInitials' ,termsAndCond ='$termsAndConditions' WHERE userId='$userId' ;";
        $this->db->query($sql);
