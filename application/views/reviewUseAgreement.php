        ...
        $(document).ready(function(){
            ...
            $('button#disapprove').click(function(){
                ...
                $.post("<?php echo base_url("?c=usragr&m=disapproveRequest&userId=".$userId);?>", {
                    ...
                    {
                        alert("Falied to Disapprove the form"+userId);
                    }
                });
            ...
            $('button#approve').click(function(){
                ...
                $.post("<?php echo base_url("?c=usragr&m=approveRequest&userId=" . $userId);?>", {
                    ...
                    if (userId > 0) {
                        ...
                        alert("Form Approved successfully for TransactionId:" + userId);

                    } else {
                        alert("Falied to Approve use agreement form For TransactionId" + userId);
                    }
                });
