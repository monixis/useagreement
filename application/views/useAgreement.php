		...
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$('button#initiate').click(function(){
					...
					$.post("<?php echo base_url("?c=usragr&m=updateResearcher&userId=".$userId);?>", {
						date:date,
						userName: userName,
						address : address,
						zipCode : zipCode,
						...
						requestList:requestList}).done(function (userId) {
						if (userId > 0) {
			...
			<div class = "container_home_child" >
				...
				<div class="content">
					...
					<div id="researcherInfo"><h1 class="page_head" style="float: none;">Use Agreement Form</h1>
						...
						<form name="form1" enctype="multipart/form-data" method="post" action="mailWithAttachment.php">
						<label for='uploaded_file'>Select A File To Upload:</label><input type="file" name="uploaded_file" id="uploaded_file">
						<button class="btn" type="submit" id="submit">Submit</button>
						</form>
						<button class="btn" type="button" id="initiate">Save</button>
					</div> <!-- researcherInfo -->
				</div> <!-- content -->
			</div>
