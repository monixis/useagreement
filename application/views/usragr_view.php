...
<html lang="en">
	<head>
		<title>COPY REQUEST/ USE AGREEMENT FORM</title>
		...
		<div class= "content_container">
			<div class = "container_home_child" >
				...
				<div class="side_bar">
					<ul>
						<li>
							<a class="side_link_current" href="#">COPY REQUEST/ USE AGREEMENT FORM</a>
						</li>
						<li>
							<a class="side_link" href="http://library.marist.edu/archives/mainpage/forms/PHOTOGRAPH%20USE%20FORM%20-%20MARIST%20COLLEGE.pdf">Photograph Use Form</a>
						</li>
						<li>
							<a class="side_link" href="http://library.marist.edu/archives/mainpage/forms/RESEARCH%20AGREEMENT%20FORM%20-%20MARIST%20COLLEGE.pdf"> Research Agreement Form</a>
						</li>
						<li>
							<a class="side_link" href="http://library.marist.edu/archives/mainpage/forms/USE%20AGREEMENT%20AND%20REPRODUCTION%20FORM%20-%20MARIST%20COLLEGE.pdf">Use Agreement and Reproduction Form</a>
						</li>
					</ul>
				</div>
				<div class= "content">
					<p class="breadcrumb">
						...
						> Forms > COPY REQUEST/ USE AGREEMENT FORM

					</p>

					<h1 class="page_head">COPY REQUEST/ USE AGREEMENT FORM</h1>
								...
								<td width="75%" align="left">
									<FORM NAME="theForm" ID="theForm" ACTION="#" METHOD="POST">
										<TABLE width="700px">
											...
											<TR><TD class="formLabel">Address</TD></TR>
											<TR>	
												<TD class="formLabel">Line1:</TD>
												<td class="ask_input" colspan="3">
													<INPUT TYPE="text" NAME="Add1" SIZE="60" />
												</TD>
											</TR>
											<TR>	
												<TD class="formLabel">Line2:</TD>
												<td class="ask_input" colspan="3">
													<INPUT TYPE="text" NAME="Add2" SIZE="60" />
												</TD>
											</TR>
											<TR>	
												<TD class="formLabel">City/State:</TD>
												<td class="ask_input" colspan="3">
													<INPUT TYPE="text" NAME="City_OR_State" SIZE="50" />
												</TD>
											</TR>
											<TR>
